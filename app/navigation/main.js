...
import BusPathList from '@screens/BusPathList';
import BusPathFilter from '@screens/BusPathFilter';
import BusPathSelectSeat from '@screens/BusPathSelectSeat';
import BusPathPreview from '@screens/BusPathPreview';
import BusPathCheckOut from '@screens/BusPathCheckOut';
...
export default function Main() {
  return (
    <MainStack.Navigator
      ...
      <MainStack.Screen name="BusPath" component={BusPath} />
      <MainStack.Screen name="BusPathList" component={BusPathList} />
      <MainStack.Screen name="BusPathFilter" component={BusPathFilter} />
      <MainStack.Screen name="BusPathSelectSeat" component={BusPathSelectSeat} />
      <MainStack.Screen name="BusPathPreview" component={BusPathPreview} />
      <MainStack.Screen name="BusPathCheckOut" component={BusPathCheckOut} />

      <MainStack.Screen name="Travels" component={Travels} />
    ...
    <BottomTab.Navigator
      ...
      <BottomTab.Screen
        ...
        options={{
          title: 'Viajar',
          tabBarIcon: ({color}) => {
            return <Icon solid color={color} name="bus-alt" size={20} solid />;
          },
        }}
      />
      ...
      {/*<BottomTab.Screen
        ...
        options={{
          title: 'Notícias',
          tabBarIcon: ({color}) => {
            return <Icon color={color} name="wind" size={20} solid />;
          },
        }}
      />
      <BottomTab.Screen
