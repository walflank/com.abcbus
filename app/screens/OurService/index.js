      ...
      <ScrollView>
        ...
        <View style={{padding: 20}}>
          ...
          <View style={{marginTop: 20}}>
            <Image source={Images.trip1} style={{width: '100%', height: 100}} />
            <View
              style={[
                styles.titleAbout,
                {
              ...
              <View style={{marginLeft: 10}}>
                ...
                <Text footnote whiteColor numberOfLines={2}>
                  Andaz Tokyo Toranomon Hills is one of the newest luxury hotels
                  in Tokyo. Located in one of the uprising areas of Tokyo
                </Text>
              </View>
            </View>
          </View>
          <View style={{marginTop: 10}}>
            <Image source={Images.trip2} style={{width: '100%', height: 100}} />
            <View
              style={[
                styles.titleAbout,
                {
          ...
          <View style={{marginTop: 10}}>
            <Image source={Images.trip3} style={{width: '100%', height: 100}} />
            <View
              style={[
                styles.titleAbout,
                {
