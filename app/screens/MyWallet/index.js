  ...
  return (
    <View style={{ flex: 1 }}>
      <Animated.View
        ...
        <Image source={Images.walletBackground} style={{ flex: 1 }} />
        <Animated.View
          style={{
            position: 'absolute',
            flexDirection: 'row',
          ...
          <View style={styles.rowBanner}>
            ...
            <View style={{ alignItems: 'flex-start' }}>
              ...
              <Text footnote whiteColor>
                3 viagens já realizadas {/*5 {t('hour_ago')} | 100k {t('views')}*/}
              </Text>
            </View>
          </View>
        ...
        <ScrollView
          ...
          <View
            ...
            {/*<Text title1 semibold numberOfLines={1} style={{ marginBottom: 10 }}>
              Seu saldo é R$ 153.20
          </Text>*/}

            {/*
            <ProfileGroup
              name="Suas últimas viagens"
